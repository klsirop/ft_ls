...
void					ft_swap_file_info(t_file_info **head, t_file_info *prev,
					t_file_info **here, int *is_end_sorting);
...
void					ft_print_dir(t_dir_info *dir_info,
							t_file_info *file_info, int is_dir);
void					ft_print_node(t_file_info *tmp, t_dir_info *dir_info,
						t_field_width *width_info, int is_device);
...
int						ft_print_like_l(char *parent_dir, char *dir_name,
...
void					ft_print_rights(struct stat status, char *path_to_file,
							t_file_info *file_info);
...
void					ft_print_time_modify(struct stat status,
									t_file_info *file_info);
void					ft_print_time_birth(struct stat status,
									t_file_info *file_info);
...
void					ft_find_year_or_time_birth(char **separate_date,
			char **separate_time, t_file_info *file_info, time_t bitime);
void					ft_find_year_or_time(char **separate_date,
			char **separate_time, t_file_info *file_info, time_t mtime);

/*
** ft_find_all_width.c
*/

void					ft_find_all_width(t_file_info *file_info,
							t_field_width **width_info);
void					ft_find_all_width_tree(t_tree *tree,
							t_field_width **width_info);
void					ft_find_first_width(t_field_width **width_info,
							t_file_info *tmp);
void					ft_find_last_width(t_field_width **width_info,
							t_file_info *tmp);
...
void					ft_find_device_width(t_field_width **width_info,
							t_file_info *tmp);
void					ft_find_time_width(t_field_width **width_info,
							t_file_info *tmp);
...
void					ft_get_group_rights(mode_t mode,
							t_file_info *file_info);
void					ft_get_other_rights(mode_t mode,
							t_file_info *file_info);
...
int						ft_is_right_order(char *parent_name, char *lhs,
							char *rhs, enum e_order_type order_type);

/*
** tree.c
*/

void					ft_print_dir_tree(t_tree *head, t_dir_info *dir_info,
								t_field_width *width_info, int is_device);
void					ft_free_t_tree(t_tree *head);
t_tree					*ft_insert_tree_element(t_tree *head, t_file_info *new,
							char *parent_name, enum e_order_type order_type);
...
int						ft_is_right_order_tmod(struct stat lhs_stat,
			struct stat rhs_stat, char *lhs, char *rhs);
...
int						ft_insert_all_dir_names_rec(char *name,
							t_lis **head, t_dir_info *dir_info);

/*
** get_file_info.c
*/

void					ft_print_size(struct stat *status,
							t_file_info *file_info);
void					ft_print_hard_links(struct stat status,
							t_file_info *file_info);
void					ft_print_user_name(struct stat status,
							t_file_info *file_info);
void					ft_print_group_name(struct stat status,
							t_file_info *file_info);
...
void					ft_output_l(t_dir_info *dir_info,
							t_file_info *file_info, int is_dir);
